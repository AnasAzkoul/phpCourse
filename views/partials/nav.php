         ...
         <div class="flex items-center">
            ...
            <div class="hidden md:block">
               <div class="ml-10 flex items-baseline space-x-4">
                  ...
                  <a
                     href="/"
                     class=" <?= checkURL('/') ?> px-3 py-2 text-sm font-medium text-white"
                     aria-current="page"
                  >Home</a >
                  <a
                     href="/about"
                     class=" <?= checkURL('/about') ?> px-3 py-2 text-sm font-medium text-white"
                  >About</a >
                  <a
                     href="/contact"
                     class=" <?= checkURL('/contact') ?> px-3 py-2 text-sm font-medium text-white"
                  >Contact</a >
            ...
            <div class="ml-4 flex items-center md:ml-6">
               ...
               <div class="relative ml-3">
                  ...
                  >
                     ...
                     <a
                        href="#" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1"
                        id="user-menu-item-0"
                     >Your Profile</a >
                     <a
                        href="#" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1"
